...
const Detail6 = (props) => {
  return (
    <Container>
      ...
      <ImageTitle>
        <img
          src="https://prod-ripcut-delivery.disney-plus.net/v1/variant/disney/A31BE6502DC7A3A01DAF58DF7E91AB6FF598A078C8FA88A1DB2D7B7E25439464/scale?width=1440&aspectRatio=1.78"
          alt="raya"
        />
      </ImageTitle>
      <ContentMeta>
        ...
        <SubTitle>
        2018 • 7m • Family, Comedy, Animation
        </SubTitle>
        <Description>
