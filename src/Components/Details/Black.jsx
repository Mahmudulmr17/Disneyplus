...
//import HJhsf from "../Images/Images/HJhsf.jpg";
...
const Black = (props) => {
  return (
    <Container>
      <Background>
        <img
          src="https://images2.alphacoders.com/127/thumbbig-1278971.webp"
          alt=""
        />
      </Background>

      <ImageTitle>
        <img src={Blackt} alt="raya" />
      </ImageTitle>
      <ContentMeta>
        <Controls>
          <Player>
        ...
        <SubTitle>2022 • 2h 42m • Action, Adventure, Science Fiction</SubTitle>
        <Description>
